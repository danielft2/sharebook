...
VALUES ('dfe8be88-3b0d-496e-baab-395b63751f43', '9780857533937','O Menino do Pijama Listrado', 'Durante a Segunda Guerra Mundial, Bruno, um garoto de oito anos,
		...
		os meninos começam uma amizade proibida.', '{"John Boyne"}', '05304a82-8a06-11ee-b9d1-0242ac120002', 1, 'Português', FALSE, TRUE, 'https://m.media-amazon.com/images/I/414LlQNVmXL.jpg', '{""}','05989174-b0fe-47a9-b8ee-394228fb66ca'),
('c0741322-0592-46a2-8206-9fd950b97f00', '9780141032009','Diário de Anne Frank', 'Anne Frank era uma criança alemã de família judaica que, aos 13 anos, teve que se esconder com os pais,
		...
		os moradores do anexo foram todos levados. Mas o Diário ficou para trás.', '{"Anne Frank"}','1734ed59-eaa8-4c31-9b38-f546790668e8', 2, 'Português', TRUE, TRUE, 'https://m.media-amazon.com/images/I/514tKci6HIL._AC_UF1000,1000_QL80_.jpg', '{""}', '05989174-b0fe-47a9-b8ee-394228fb66ca'),
('eb43f38c-887b-410e-ad5f-624861cf6c95', '9788574805986','Memórias Póstumas de Brás Cubas', 'Após ter morrido, em pleno ano de 1869, Brás Cubas decide por narrar sua história e revisitar os fatos mais importantes de sua vida, a fim de se distrair na eternidade.
		A partir de então ele relembra de amigos como Quincas Borba, de sua displicente formação acadêmica em Portugal, dos amores de sua vida e ainda do privilégio que teve de nunca ter precisado trabalhar em sua vida.', '{"Machado de Assis"}','58d43f0c-5442-48b4-8103-4ec2bcd42ea6', 3, 'Português', TRUE, TRUE, 'https://m.media-amazon.com/images/I/817OglcU6LL._SY522_.jpg', '{""}', '448358ea-c333-4982-ac6e-627b75d2e6cc');
